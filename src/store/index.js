    ...
    courses: [
      ...
      },
      {
        ...
        fullDescription: '<p>Способность легко осваивать разговорный язык заложена в нас генетически. Каждый школьник еще до изучения грамматики уже свободно общается на родном языке с родителями и друзьями.</p><br/>' +
          ...
          '<p>В авторской методике воспроизводится естественный процесс освоения языка: через общение, реальные жизненные ситуации, погружение в языковую среду. После прохождения обучения ваше общение станет лёгким и свободным. Вы сможете общаться с носителями языка и поддерживать разговор практически на любую тему.</p>',
